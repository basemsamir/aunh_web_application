...
class HomeController extends Controller
{
    ...
    {	//dd(Session::get('proc_devices'));
        ...
        return view('home.form.store_reservation',compact('devices','device_procedures','rs_places_list','patients'));
    }
	...
	public function ajaxGetAllPatientsToday(Request $request){
		if($request->ajax()){
			...
			if(empty(trim($request->input('search.value'))) || $request->input('search.value')=="")
			{            
