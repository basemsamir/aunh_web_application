...
@section('forms')
{!! Form::model($patient,['method'=>'PATCH','id'=>'patient_form','route'=>['ris.patient.update',$patient->id]]) !!}
<div class="col-md-12">
...
// Function calculate the age
function getYearAge(birthdate){
	var today=new Date();
...
// Function set age year
function setYearAge(birthdate){
	if(birthdate != ""){
		getYearAge(birthdate);
	}
	else{
		$("#year_age").val("");
	}
}
// Function calculates the birthdate field
