<div class="col-md-6">
	<div class="panel panel-default">
		<div class="panel-heading">بيانات التحاليل</div>
				...
				<div class="row ">
						...
						<div class="col-lg-6">
							...
							<div class="form-group" >
								{!! Form::label('تاريخ التحليل',null,array('class'=>'required')) !!}
							...
							<div class="form-group" >
								{!! Form::label('طبيب التحاليل',null,array('class'=>'required')) !!}
						...
						<div class="col-lg-6">
							...
							<div class="form-group" >
								{!! Form::label('نوع التحليل',null,array('class'=>'required')) !!}
								{!! Form::select('procedure',$device_procedures,null,['id'=>'procedure_name','class'=>'form-control','change'=>'changeDevice']) !!}
							</div>
							<div class="form-group" >
								{!! Form::label('حالة التحليل',null,array('class'=>'required')) !!}
								{!! Form::select('procedure_status',['Arriving'=>'اليوم','Schedular'=>'مجدولة'],'Arriving',['id'=>'procedure_status','class'=>'form-control']) !!}
							</div>
							<button type="button" class="btn btn-primary" onclick="addProcedure()" >إضافة التحليل</button>
						</div>
				</div>

	</div>
	<div class="panel panel-default">
		<div class="panel-heading">التحاليل التي تم حجزها</div>
		<div class="panel-body">
			<table id="proc_device_tb" class="table table-bordered">
				<thead >
				<tr>
				  <th style="text-align:center">أسم الجهاز</th>
				  <th style="text-align:center">نوع التحليل</th>
					<th style="text-align:center">تاريخ التحليل</th>
